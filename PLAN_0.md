...
| D10 | **Proto package path**: `hulation.v1.<service>`; Go import path `github.com/tlalocweb/hulation/pkg/apispec/v1/<service>` (matching hula's existing module path). Mirrors izcr's pattern. | Predictable, greppable. |
