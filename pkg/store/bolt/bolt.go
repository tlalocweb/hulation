...
const (
	...
	BucketConsentLog        = "consent_log"         // key = "server_id|visitor_id|ts", value = JSON StoredConsent
	BucketCookielessSalts   = "cookieless_salts"    // key = server_id, value = 32-byte salt
)
